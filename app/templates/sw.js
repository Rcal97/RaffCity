/*Cuore della PWA, gira in BG nel Browser e intercetta tutte le richieste di rete
gestisce la cache e permette all'app di funzionare anche offline.
*/
let cacheName = 'raffcityCache';
let filesToCache = [
    '/',
    './static/css/base.css',
